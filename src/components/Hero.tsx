        ...
        <div className="container">
          <div className="flex gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              Com equipamentos de alta precisão certificados pelo RBC e equipe qualificada, estamos aptos a elaborar relatórios técnicos de medição sonora para diferentes finalidades.</p>
            </div>
          </div>
        </div>
      </section>
